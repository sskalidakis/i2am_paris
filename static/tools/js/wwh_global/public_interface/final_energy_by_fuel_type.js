$(document).ready(function () {
    create_final_energy_ft_2020_viz();
    create_final_energy_ft_2030_viz();
    create_final_energy_ft_2050_viz();

    function create_final_energy_ft_2020_viz() {
        var viz_id = 'final_energy_ft_2020';
    ...
    function create_final_energy_ft_2030_viz() {
        var viz_id = 'final_energy_ft_2030';
        var viz_type = 'show_stacked_clustered_column_chart';
        var intrfc = 'wwhglobal_pub';
        var viz_frame = $('#' + viz_id + '_viz_frame_div');
        viz_frame.show();
    ...
    function create_final_energy_ft_2050_viz() {
        var viz_id = 'final_energy_ft_2050';
        var viz_type = 'show_stacked_clustered_column_chart';
        var intrfc = 'wwhglobal_pub';
        var viz_frame = $('#' + viz_id + '_viz_frame_div');
        viz_frame.show();
