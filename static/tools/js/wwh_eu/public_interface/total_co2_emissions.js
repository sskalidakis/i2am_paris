$(document).ready(function () {
    ...
    function start_qc_v_total_co2_emissions_process(variable, json_query_obj) {
        var query = {};
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                create_visualisation_total_co2_emissions(query_id, json_query_obj['val_list'], json_query_obj['title_list'], json_query_obj['unit_list'], variable);
            },
            error: function (data) {
                console.log(data);
            }
    ...
    function create_visualisation_total_co2_emissions(query_id, val_list, title_list, unit_list, variable) {
    ...
    function retrieve_series_info_total_co2_emissions(jq_obj) {
        const units_info = {
        ...
        $.ajax({
            ...
            contentType: 'application/json',
            success: function (data) {
                console.log('total_co2_emissions Unit Info Retrieved');
                ...
                start_qc_v_total_co2_emissions_process(jq_obj["variables"], json_object)
