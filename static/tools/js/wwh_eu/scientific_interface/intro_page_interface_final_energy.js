$(document).ready(function () {
    ...
    $("#final_by_sector-clear-button").click(function () {
        $('#final_by_sector select.sum-boot-select').multipleSelect('setSelects', []);
        $('#final_by_sector_viz_frame_div').hide();
    });

    $("#final_by_sector-run-button").click(function () {
        var viz_id = 'final_by_sector';
        ...
        var model_sel = $('#final_by_sector_model_name');
        ...
        if (model_full) {
            ...
            var viz_payload = {
                ...
                "color_list_request": ["dark_gray", "light_blue", "green", "gold"],
                "dataset_type": "query",
                "type": "normal"
            };
    ...
    function create_final_by_sector_query(dataset) {
        var sel_model = $('#final_by_sector_model_name');
        var variables = ['Final Energy|Industry',
            'Final Energy|Residential and Commercial',
            'Final Energy|Transportation',
            'Final Energy|Other']
    ...
    $("#final_by_sector-run-button").trigger('click');
});
